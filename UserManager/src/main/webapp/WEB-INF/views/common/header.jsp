...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/top-menu.js"></script>
</head>
<body>
	...
	<header id="topMenu" class="container-fluid border-bottom pt-2 pb-2 h-3-poring-5-rem">
		<section class="row">
			...
			<section class="col-md-2 align-self-end">
				<button class="btn btn-success btn-sm" data-btn-type="login">로그인</button>
				<button class="btn btn-success btn-sm" data-btn-type="join">회원가입</button>
			</section>
		</section>
	</header>